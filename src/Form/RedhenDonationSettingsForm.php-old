 ...
 *
 * @package Drupal\redhen_donation\Form
 *
 * @ingroup redhen_donation
 */
class RedhenDonationSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'redhen_donation_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['redhen_donation.settings'];
  }
